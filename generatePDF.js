...
// Draw a bordered cell (fills bg, strokes border, draws text)
...
async function generatePDF(formData) {
  ...
  return _build(formData, logoBuffer);
}

function _build(formData, logoBuffer) {
  return new Promise((resolve, reject) => {
    ...
    // ── Water Quality Table ───────────────────────────────────────────────────
    const WQ = [120, 75, 75, CW - 120 - 75 - 75]; // col widths
